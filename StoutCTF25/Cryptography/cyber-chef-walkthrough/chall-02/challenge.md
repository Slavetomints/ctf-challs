...
This time, we are going to talk about stacking up blocks to make a full fledged recipe. Last time we learned how to use just one block, but thats pretty boring. We want to really start to push CyberChef to its limits.

All you need to do is drag another block down onto the recipe, and voilà, you have it!

![image](cyberchef-2-multiple.png)
